...
local function lsp_keymaps(bufnr)
      ...
      vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>s', '<cmd>lua vim.diagnostic.setloclist()<CR>', opts)
...
return { setup = setup, on_attach = on_attach, capabilities = capabilities }
